...
from ur_yt_gripper_moveit_config import MoverService, MoverServiceRequest, MoverServiceResponse
...
def plan_trajectory(move_group, destination_pose, start_joint_angles): 
    ...
    if not plan:
        exception_str = """
            Tt be plrajectory could noanned for a destination of {} with starting joint angles {}.
